...
MergeOp = _reflection.GeneratedProtocolMessageType('MergeOp', (_message.Message,), dict(
  DESCRIPTOR = _MERGEOP,
  __module__ = 'neuclease.dvid.labelops_pb2'
...
_LABELINDEX_BLOCKSENTRY.has_options = True
_LABELINDEX_BLOCKSENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
